                ...
                <div class="page-content">                   
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?= base_url() ?>savvy1/FeeChallan">Unpaid Challans</a>
                            </li>                            
                        </ul>                       
                    </div>
                    <div class="row">
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="btn-group">  
                                            <a href="<?= base_url() ?>savvy1/FeeChallan/createIndividualChallan">
                                             ...
                                             <div class="btn-group">  
                                            <a href="<?= base_url() ?>savvy1/FeeChallan/createGroupChallan">
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" id="sample_1">
                                    ...
                                    ?>             
                                        <tr>
                                            ...
                                            <td>
                                             <form action="<?= base_url() ?>savvy1/FeeChallan/payFeeChallan" onsubmit="return validateForm()"  method="post">
