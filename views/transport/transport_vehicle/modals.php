            ...
            <div class="modal-body">
                <form action="#" class="form-horizontal" id="stop_form">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name="veh_type" id="veh_type" class="form-control" placeholder="Select Transport Route">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name="route_id" id="route_id" class="form-control" placeholder="Select Transport Route">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text"  name="veh_name" id="veh_name" class="form-control" placeholder="Enter Vehicle Name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Vehicle Power</label>
                        <div class="col-md-8">
                            <input type="text" name="veh_power" id='veh_power' class="form-control" placeholder="Enter Vehicle Horse Power">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="veh_capacity" id='veh_capacity' class="form-control" placeholder="Enter Vehicle Seat Capacity">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Driver Name</label>
                        <div class="col-md-8">
                            <input type="text" name="veh_driver" id='veh_driver' class="form-control" placeholder="Enter Driver Name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Driver Mobile</label>
                        <div class="col-md-8">
                            <input type="text" name="veh_mobile" id='veh_mobile' class="form-control" placeholder="Enter Driver Mobile Number">
                        </div>
                    </div>
                </form>
            </div>
