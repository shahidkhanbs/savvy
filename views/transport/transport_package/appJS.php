<script>
    ...
    $(document).on('click', '#save_stop', function(e) {
        ...
        $.ajax({
            data: data,
            type: "post",
            url: base_url + "savvy1/TransportPackage/store",
    ...
    function deletePackage(id, status) {
        confirmDelete('Do you want to DELETE this record?').then(function() {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + "savvy1/TransportPackage/toggle",
                data: {
                    id: id,
                    status: status
                },
    ...
    function activePackage(id, status) {
    ...
    function editPackage(id) {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + "savvy1/TransportPackage/edit",
                data: {
                    id: id
                },
                dataType:"json", 
                success: function(data) {                  
                     ...
                     $('#id').val(data.id);  
                     $('#stop_id_edit').val(data.stop_id);
                     $('#package_amount_edit').val(data.package_amount);
                }
            })
    ...
    $(document).on('click', '#edit_stop', function(e) {
        ...
        $.ajax({
            data: data,
            type: "post",
            url: base_url + "savvy1/TransportPackage/update",
            success: function(data) {
